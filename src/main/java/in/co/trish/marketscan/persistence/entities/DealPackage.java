...
public class DealPackage extends IdEntity {
	...
	public String toString() {
		...
		builder.append("DealPackage [name=").append(name).append(", code=").append(code).append(", dealCount=")
				.append(dealCount).append(", packageValidity=").append(packageValidity).append(", dealValidity=")
				.append(dealValidity).append("]");
