...
public class SellerReview extends IdEntity {
	 ...
	 * @param reviewer
	 */
	public SellerReview(boolean isRrespectful, boolean wasQualityOk, boolean wasQuantityOk, boolean isRecommended,
			int overallRating, String comment, Person seller, Person reviewer) {
		super();
	...
	public String toString() {
		...
		builder.append("SellerReview [isRrespectful=").append(isRrespectful).append(", wasQualityOk=")
				.append(wasQualityOk).append(", wasQuantityOk=").append(wasQuantityOk).append(", isRecommended=")
				.append(isRecommended).append(", overallRating=").append(overallRating).append(", comment=")
				.append(comment).append(", seller=").append(seller).append(", reviewer=").append(reviewer).append("]");
