...
public class Person extends IdEntity {
	...
	public Person(String fullName, String userName, String password, String uuid, String macAddress, String ipAddress, String deviceId, String shopName, String mobileNo, String landlineNo, String whatsappNo, String emailAddress, String physicalAddressLine1, String physicalAddressLine2, String landmark, String town, String locality, String longitude, String lattitude, Date lastLoginDate, String lastActivity, boolean isDeliveryAvailable, Date registrationDate, Role role, City city, DealAccount dealAccount) {
	...
	public String toString() {
		...
		builder.append("Person [fullName=").append(fullName).append(", userName=").append(userName).append(", password=").append(password).append(", uuid=").append(uuid).append(", macAddress=").append(macAddress).append(", ipAddress=").append(ipAddress).append(", deviceId=").append(deviceId).append(", shopName=").append(shopName).append(", mobileNo=").append(mobileNo).append(", landlineNo=").append(landlineNo).append(", whatsappNo=").append(whatsappNo).append(", emailAddress=").append(emailAddress).append(", physicalAddressLine1=").append(physicalAddressLine1).append(", physicalAddressLine2=").append(physicalAddressLine2).append(", landmark=").append(landmark).append(", town=").append(town).append(", locality=").append(locality).append(", longitude=").append(longitude).append(", lattitude=").append(lattitude).append(", lastLoginDate=").append(lastLoginDate).append(", lastActivity=").append(lastActivity).append(", isDeliveryAvailable=").append(isDeliveryAvailable).append(", registrationDate=").append(registrationDate).append(", role=").append(role).append(", city=").append(city).append(", dealAccount=").append(dealAccount).append("]");
