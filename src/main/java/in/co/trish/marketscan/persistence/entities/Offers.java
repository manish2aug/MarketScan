...
public class Offers extends IdEntity {
	...
	public String toString() {
		...
		builder.append("Offers [seller=").append(seller).append(", product=").append(product).append(", price=")
				.append(price).append(", isDeal=").append(isDeal).append(", publishedDate=").append(publishedDate)
				.append("]");
