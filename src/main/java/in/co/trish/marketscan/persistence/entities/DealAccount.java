...
public class DealAccount extends IdEntity {
	...
	public String toString() {
		...
		builder.append("DealAccount [dealPackageId=").append(dealPackageId).append(", purchaseDate=")
				.append(purchaseDate).append(", availableDealBalance=").append(availableDealBalance).append("]");
