...
values ('Deepak Chaurisiya', '', '', '', 'D0-53-49-55-20-E3', '192.168.1.1', 'm00123456', '9999048156', '01212556599', '9999048156', 'deepak0123@gmail.com', 'Deepak Book Store', '201 shivlok puri', 'kanker khera', 'krishna public school', 'old cant', 'cantt', 'kanker khera', '250001', '28.12345678', '-26.01234563', '2016-06-01', 'Searched: Nuclear physics', false, '2015-05-05', (SELECT ID FROM market_scan.role where code = 'S'), (SELECT ID FROM market_scan.city where code = 'MUT'), null);
INSERT INTO market_scan.person(full_name, user_name, password, uuid, mac_address, ip_address, device_id, mobile_no, landline_no, whatsapp_no, email_address, shop_name, physical_address_line1, physical_address_line2, landmark, sub_locality, locality, town, pin_code, longitude, lattitude, last_login_date, last_activity, is_delivery_available, registration_date, role_id, city_id, deal_account_id) 
values ('Amit Tomer', '', '', '', 'D0-53-49-55-20-E4', '192.168.1.2', 'm00123457', '9999048157', '01212556590', '9999048157', 'amit0123@gmail.com', 'Amit Book Store', '202 shivlok puri', 'kanker khera1', 'krishna public school1', 'old cant', 'cantt', 'kanker khera1', '250001', '28.12345679', '-26.01234564', '2016-06-02', 'Searched: Quantum physics', false, '2015-05-06', (SELECT ID FROM market_scan.role where code = 'S'), (SELECT ID FROM market_scan.city where code = 'MUT'), null);
INSERT INTO market_scan.person(full_name, user_name, password, uuid, mac_address, ip_address, device_id, mobile_no, landline_no, whatsapp_no, email_address, shop_name, physical_address_line1, physical_address_line2, landmark, sub_locality, locality, town, pin_code, longitude, lattitude, last_login_date, last_activity, is_delivery_available, registration_date, role_id, city_id, deal_account_id) 
values ('Sunil Baliyan', '', '', '', 'D0-53-49-55-20-E5', '192.168.1.3', 'm00123458', '9999048158', '01212556591', '9999048158', 'sunil0123@gmail.com', 'Sunil Book Store', '203 shivlok puri', 'kanker khera2', 'krishna public school2', 'new cant', 'cantt', 'kanker khera2', '250001', '28.12345670', '-26.01234565', '2016-06-03', 'Searched: Organic chemistry', true, '2015-05-07', (SELECT ID FROM market_scan.role where code = 'S'), (SELECT ID FROM market_scan.city where code = 'MUT'), null);
INSERT INTO market_scan.person(full_name, user_name, password, uuid, mac_address, ip_address, device_id, mobile_no, landline_no, whatsapp_no, email_address, shop_name, physical_address_line1, physical_address_line2, landmark, sub_locality, locality, town, pin_code, longitude, lattitude, last_login_date, last_activity, is_delivery_available, registration_date, role_id, city_id, deal_account_id) 
values ('Amit Singh', '', '', '', 'D0-53-49-55-20-E6', '192.168.1.4', 'm00123459', '9999048159', '01212556592', '9999048159', 'amits0123@gmail.com', 'AmitS Book Store', '204 shivlok puri', 'kanker khera3', 'krishna public school3', 'old cant', 'cantt', 'kanker khera3', '250001', '28.12345671', '-26.01234566', '2016-06-04', 'Searched: Inorganic chemistry', false, '2015-05-08', (SELECT ID FROM market_scan.role where code = 'S'), (SELECT ID FROM market_scan.city where code = 'MUT'), null);
INSERT INTO market_scan.person(full_name, user_name, password, uuid, mac_address, ip_address, device_id, mobile_no, landline_no, whatsapp_no, email_address, shop_name, physical_address_line1, physical_address_line2, landmark, sub_locality, locality, town, pin_code, longitude, lattitude, last_login_date, last_activity, is_delivery_available, registration_date, role_id, city_id, deal_account_id) 
values ('Vimal Kumar', '', '', '', 'D0-53-49-55-20-E7', '192.168.1.5', 'm00123450', '9999048150', '01212556593', '9999048150', 'vimal0123@gmail.com', 'Vimal Book Store', '205 shivlok puri', 'kanker khera4', 'krishna public school4', 'new cant', 'cantt', 'kanker khera4', '250001', '28.12345672', '-26.01234567', '2016-06-05', 'Searched: Numerical analysis', true, '2015-05-09', (SELECT ID FROM market_scan.role where code = 'S'), (SELECT ID FROM market_scan.city where code = 'MUT'), null);
