...
INSERT INTO market_scan.brand(name_english, name_hindi, code) VALUES ('Kedar Nath Ram Nath Edducational Publishers', '', 'KNRN');
...
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Lenear Programming For B.Sc. Part-III Paper-IV(B)', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Complex Analysis For B.Sc. Part-III Paper-II', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Operations Research Theory, Methods and Applications', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Differential Equations', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Numerical Analysis and Programming in C for B.Sc Part III Paper III', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Real Analysis for B.Sc (T.D.C.) Part III Paper I', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Complex Analysis for B.Sc. Part III, Paper II', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Real Analysis for B.A./B.Sc. ( T.D.C.) Part III, Paper I', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Numerical Analysis and Programimg in C for B.Sc Part III, Paper III', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Linear Programming for B.Sc. Part III, Paper IV (b)', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Linear Algebra And Matrices', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Mechanics for B.A./B.Sc. (Part II Paper III)', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Mechanics', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Differential Equations And integral Transforms', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Linear Algebra And Matrices', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Differential Equations And integral Transforms', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Optimization Technique in Engineering', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Operations Research for Engineering and Technology (U.P.T.U)', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Operations Research (JNTU)', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Operations Research (Visvesvaraya Technological University, Belgaum (Karnataka) For B.Tech VIth Semester', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Operations Research (Visvesvaraya Technological University, Belgaum (Karnataka) For B.Tech VIIth Semester', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Mathematical Statistics', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Co-Ordinate Solid Geometry', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Differential Geometry', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Spherical Astronomy', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Attraction and Potential', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Hydro - Statics', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Functions of a Complex Variable', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Dynamics of Rigid Bodies', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Elementary Hydro Dynamics', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Geometry And Vector Analysis For B.A./B.Sc. (T.D.C.) Part- I Paper-III', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Calculus', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Algebra And Trignometry', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Topology', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Complex Analysis', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('Applied Statistics', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('A Text Book of Geometry & Vector Calculus', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('A Text Book of Calculus', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
INSERT INTO market_scan.item(name_english, name_hindi, unit, subcategory, brand) VALUES ('A Text Book of Algebra & Trignometry', '', 'per copy', (SELECT id FROM market_scan.subcategory WHERE code = 'ACEDMIC_BOOKS'),(SELECT id FROM market_scan.brand WHERE code = 'KNRN'));
